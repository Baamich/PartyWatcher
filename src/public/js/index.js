...
const infoTexts = {
  ...
  player_capture: 'Вставь ссылку на страницу с фильмом/сериалом. Оптимизировано для: Kinogo(https://kinogo2026.com) и их возможные другие домены (могут быть нюансы, но должно работать фильм/сериал). Другие сайты (Rezka и т.д.) тоже могут сработать, но не гарантировано. Для некоторых сайтов будет доступен выбор сезона/серии/озвучки.',
  direct: 'Если у тебя уже есть прямая ссылка на видео — вставь её сюда. Подходит и ссылка на сам видеофайл (.mp4, .m3u8), и ссылка на embed-плеер сайта (например, у my.mail.ru это вид https://my.mail.ru/video/embed/...). Работает быстрее и надёжнее "Захвата плеера", потому что ничего не нужно распознавать через прокси — но такую ссылку нужно найти самому.',
