...
const infoTexts = {
  ...
  player_capture: 'Вставь ссылку на страницу с фильмом/сериалом. Оптимизировано для: Kinogo и их возможные другие домены (могут быть нюансы, но должно работать фильм/сериал). Другие сайты (Rezka и т.д.) тоже могут сработать, но не гарантировано. Для некоторых сайтов будет доступен выбор сезона/серии/озвучки.',
};
